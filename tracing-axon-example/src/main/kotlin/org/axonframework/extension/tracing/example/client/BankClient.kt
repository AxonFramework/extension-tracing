...
package org.axonframework.extension.tracing.example.client

import mu.KLogging
import org.axonframework.commandhandling.gateway.CommandGateway
import org.axonframework.extension.tracing.example.api.AccountBalanceQuery
import org.axonframework.extension.tracing.example.api.CreateBankAccountCommand
import org.axonframework.extension.tracing.example.api.DepositMoneyCommand
...
class BankClient(
    ...
    fun balance() {
        val amount = queryGateway.query(
            "org.axonframework.extension.tracing.example.api.AccountBalanceQuery",
            AccountBalanceQuery(
                bankAccountId = accountId
            ),
